        ...
        $.easyui.forEach(_19b.data, true, function(node) {
            if(opts.filter.call(_19a,q,node)){
                ...
                if(node.children && node.children.length > 0){
                    if($("#testSuiteTree").tree('getParent',node.target) == null){
                        $("#"+node.domId).addClass("tree-node-hidden");
                        node.hidden=true;
                    }
                }
                //will hide empty testsuites
                else if(node.children){
                    $("#"+node.domId).addClass("tree-node-hidden");
                    node.hidden=true;
                }
                else{
                    if($("#testSuiteTree").tree('getParent',node.target).hidden){
                        $("#"+node.domId).addClass("tree-node-hidden");
                        node.hidden=true;
                    }
                }
...
(function($) {
    ...
    function _917(_919, _91a, _91b, _91c) {
        ...
        if (_91b == undefined) {
            if (ck.hasClass("tree-checkbox1") && ck.hasClass("tree-checkbox3")) {
                _91b = false;
            } else {
                if (ck.hasClass("tree-checkbox0")) {
                    _91b = true;
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        singleSelect: true,
        view: _99a,
        rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _910(true), mouseout: _910(false), click: _912 }),
